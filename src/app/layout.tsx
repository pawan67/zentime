...
import { DM_Mono, Geist_Mono, Inter, Space_Mono } from "next/font/google";
import "./globals.css";
...
export const metadata: Metadata = {
  title: "ZenTime - Pomodoro Timer",
  description:
    "A beautiful and efficient Pomodoro timer for better productivity",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <meta name="application-name" content="ZenTime" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="default" />
        <meta name="apple-mobile-web-app-title" content="ZenTime" />
        ...
        <link
          rel="apple-touch-startup-image"
          href="/icons/apple-splash-2868-1320.png"
        ...
        <link
          rel="apple-touch-startup-image"
          href="/icons/apple-splash-2622-1206.png"
      ...
      <body className={geistMono.className}>
        ...
        >
          <div className="px-8 py-3 max-w-md mx-auto mx-auto px-4">
            <Header />
            {children}
          </div>
          <Toaster richColors />
